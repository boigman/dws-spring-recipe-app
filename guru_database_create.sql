...
create table ingredient (id bigint not null auto_increment, amount decimal(10,4), description varchar(255), recipe_id bigint, uom_id bigint, primary key (id)) engine=InnoDB
